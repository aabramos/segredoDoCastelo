/*
 * Determina um baú que explode ao ser aberto.
 */
...
/**
 * A classe BauExplosivo, que instancia um baú que explode ao ser aberto.
 */
public class BauEuAbrindoBau extends Construcao implements UsarInterface {
     ...
     * @param y 
     */
    public BauEuAbrindoBau(double x, double y) {
        super(x, y);
        imortal = false;
        vidaInicial(18);
        tamanho(27, 10);
    ...
    public Bitmap getSprite() {
        return Arte.bauEuAbrindoBau[status][0];
    }
