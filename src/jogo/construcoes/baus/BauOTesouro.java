...
/**
 * A classe BauOTesouro, que manuseia baús com tesouro no jogo.
 */
public class BauOTesouro extends Construcao implements UsarInterface {
     ...
     * @param y
     */
    public BauOTesouro(double x, double y) {
        super(x, y);
        imortal = false;
        vidaInicial(18);
        tamanho(27, 10);
    ...
    public Bitmap getSprite() {
        return Arte.bauOTesouro[status][0];
    }
