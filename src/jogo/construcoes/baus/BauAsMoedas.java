 ...
 */
public class BauAsMoedas extends Construcao implements UsarInterface {
     ...
     * @param y
     */
    public BauAsMoedas(double x, double y) {
        super(x, y);
        imortal = false;
        vidaInicial(18);
        tamanho(27, 10);
    ...
    public Bitmap getSprite() {
        return Arte.bauAsMoedas[status][0];
    }
     ...
     * @see jogo.construcoes.Construcao#usar(jogo.entidades.Entidade)
     */
