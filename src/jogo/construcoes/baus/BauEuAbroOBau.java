...
/**
 * A classe BaúEuAbroOBau, que manuseia baús com tesouro no jogo.
 */
public class BauEuAbroOBau extends Construcao implements UsarInterface {
     ...
     * @param y
     */
    public BauEuAbroOBau(double x, double y) {
        super(x, y);
        imortal = false;
        vidaInicial(18);
        tamanho(27, 10);
    ...
    public Bitmap getSprite() {
        return Arte.bauEuAbroOBau[status][0];
    }
